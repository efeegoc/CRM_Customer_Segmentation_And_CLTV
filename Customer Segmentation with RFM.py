...
###############################################################
# FLO müşterilerini segmentlere ayırgıp bu segmentlere göre pazarlama stratejileri belirlemek istiyor.
...
# Veriyi Anlama (Data Understanding) ve Hazırlama
           # 1. flo_data_20K.csv verisini okuyalim.
           # 2. Veri setinde
                     # a. İlk 10 gözlem,
                     # b. Değişken isimleri,
                     # c. Betimsel istatistik,
                     # d. Boş değer,
                     # e. Değişken tipleri, incelemesi yapalim.
           # 3. Omnichannel müşterilerin hem online'dan hemde offline platformlardan alışveriş yaptığını ifade etmektedir. Herbir müşterinin toplam
           # alışveriş sayısı ve harcaması için yeni değişkenler oluşturalım.
           # 4. Değişken tiplerini inceleyelim. Tarih ifade eden değişkenlerin tipini date'e çevirelim.
           # 5. Alışveriş kanallarındaki müşteri sayısının, ortalama alınan ürün sayısının ve ortalama harcamaların dağılımına bakalım.
           # 6. En fazla kazancı getiren ilk 10 müşteriyi sıralayalım.
           # 7. En fazla siparişi veren ilk 10 müşteriyi sıralayalım.
           # 8. Veri ön hazırlık sürecini fonksiyonlaştıralım.
...
# flo_data_20K.csv verisini okuyalım.Dataframe’in kopyasını oluşturalımuz.
...
# Veri setinde
        ...
        # e. Boş değer,
        # f. Değişken tipleri, incelemesi yapalım.
...
# Alışveriş kanallarındaki müşteri sayısının, toplam alınan ürün sayısı ve toplam harcamaların dağılımına bakalım.
...
# RFM analizi yardımı ile 2 case için ilgili profildeki müşterileri bulalım ve müşteri id'lerini csv ye kaydedelim.
